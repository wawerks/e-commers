...
CREATE TABLE `User` (
    ...
    `sellerStatus` ENUM('PENDING', 'APPROVED', 'REJECTED') NOT NULL DEFAULT 'PENDING',
...
CREATE TABLE `Order` (
    `id` VARCHAR(191) NOT NULL,
    `userId` VARCHAR(191) NOT NULL,
    `status` ENUM('CREATED', 'PAID', 'FULFILLING', 'SHIPPED', 'COMPLETED', 'CANCELED') NOT NULL DEFAULT 'CREATED',
